...
import 'package:flutter_animation/screens/clock/digit.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        _buildDigit(
          timeStream,
          (DateTime time) => (timeLeft.inHours % 24),
          DateTime.now(),
          "Hours",
        ),
        _buildDigit(
          timeStream,
          (DateTime time) => (timeLeft.inMinutes % 60),
          DateTime.now(),
          "minutes",
        ),
      ],
